...
function processFile() {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    // Only process D1 schools
    if (currentDivision === 'D1' && line.includes('"400m Hurdles"') && currentGender) {
  ...
  if (addedCount === 0) {
    console.log('✅ All D1 schools already have 300m Hurdles!');
  } else {
    console.log(`\nAdded ${addedCount} 300m Hurdles standards to D1 schools`);
